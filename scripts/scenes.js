Crafty.scene('Loading', function () {
	...
	Crafty.load(['assets/black.png', 'assets/white.png', 'assets/white_pip.png', 'assets/black_pip.png', 'assets/black_off.png', 'assets/white_off.png', 'assets/1.png', 'assets/2.png', 'assets/3.png', 'assets/4.png', 'assets/5.png', 'assets/6.png', 'assets/off.png', 'assets/bar.png'],
		function () {
			...
			Crafty.sprite(50, 10, 'assets/black_off.png', { spr_black_off: [0, 0] });
			Crafty.sprite(50, 10, 'assets/white_off.png', { spr_white_off: [0, 0] });
...
Crafty.scene('Game', function () {
	...
	_(5).times(function () {
		Game.addChecker('White', 18);
	});

	_(2).times(function () {
		Game.addChecker('Black', 23);
	});
	_(5).times(function () {
		Game.addChecker('Black', 12);
	});
	_(3).times(function () {
		Game.addChecker('Black', 7);
	});
	_(5).times(function () {
		Game.addChecker('Black', 5);
	});

	Game.whiteOff = Crafty.e('OffBox');
	Game.blackOff = Crafty.e('OffBox');
	Game.blackOff.y = 480;
	Game.blackOff.position = -1;
